Graph Traversal: An interactive graph visualizer that allows you to explore graph algorithms (BFS, DFS, and Dijkstra) step by step with animated, hand-drawn style nodes and edges.
